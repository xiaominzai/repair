                ...
                <div class="content-panel">
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                ...
                                <td>
                                    <button class="btn btn-success btn-xs" onclick="reTrash(<?php echo ($v["id"]); ?>,this,'<?php echo U(GROUP_NAME."/Index/resTrash");?>')">撤销删除</button>
                                    <button class="btn btn-primary btn-xs" onclick="layer1('<?php echo U(GROUP_NAME."/Index/detail",array('id' => $v["id"]));?>')">详情</button>
                                    <button class="btn btn-danger btn-xs"><i class="fa fa-trash-o " onclick="del(<?php echo ($v["id"]); ?>,this,'<?php echo U(GROUP_NAME."/Index/deltrash");?>')"></i></button>
                                </td>
